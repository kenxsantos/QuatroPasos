                            ...
                            <div id="booking_form">
                                <form name="contactForm" id='contact_form' class="form-border" method="post">
                                    <div id="step-2" class="row">
                                        ...
                                        <div class="col-md-12">
                                            <img src="display_image.php?id=<?php echo $roomid; ?>" alt="Room Image"
                                                style="width: 300px; height: 300px">
                                            <br><br>
                                            <div>
                                                <input type='text' name='Rmtype' id='Rmtype' class="form-control"
                                                    placeholder="<?php echo $row["type"] ?>">
                                            </div>
                                            <div>
                                                <input type='text' name='Price' id='Price' class="form-control"
                                                    placeholder="Price: <?php echo $row["Price"] ?>">
                                            </div>
                                            <div>
                                                <input type='text' name='Pax' id='Pax' class="form-control"
                                                    placeholder="Pax: <?php echo $row["Pax"] ?>">
                                            </div>
                                        </div>
