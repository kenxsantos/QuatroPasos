...
$stmtUsers = $pdo->query("SELECT * FROM `users` WHERE role_as = 1 OR role_as = 2");
                                    ...
                                    <table id="" class="table" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($row["role_as"] == 1 ? "Admin" : "Receptionist"); ?>
                                                </td>
                                                <td>
                                                    <a href="table-datatable-customer-edit.php?accountId=<?php echo urlencode($row["id"]); ?>"
                                                        class="btn-edit">
                                                        Edit
                                                    </a>
                                                    <a href="table-datatable-customer-delete.php?accountId=<?php echo urlencode($row["id"]); ?>"
                                                        class="btn-delete">
                                                        Delete
                                                    </a>
                                                </td>
